class Type_loan {
  final Loan_image, Loan_Text,Loan_descrip;

  Type_loan(this.Loan_image, this.Loan_Text,this.Loan_descrip);
}

final List<Type_loan> Loan_List = List.generate(
    Loan_image.length,
        (index) => Type_loan(
          Loan_image[index],
          Loan_Text[index],
...
List Loan_image = [
  "asset/image/personal-loan-icon.png",
  "asset/image/gold-loan-icon.png",
  "asset/image/home-loan-icon.png",
  "asset/image/business-loan-icon.png",
  "asset/image/education-loan-icon.png",
  "asset/image/car-loan-icon.png",
];
List Loan_Text = [
  """Personal
\t\t\tLoan""",
